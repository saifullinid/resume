...
### ОБО МНЕ ###
<div>
	<p>Меня зовут Ильдар, на текущий момент я в поисках позиции Junior разработчика, интересуюсь технологиями различной направленности, но максимальный интерес представляет Python.</p>
	<p style= 'margin-top: -10px;'>Большую часть времени в своей профессиональной деятельности я посвятил монтажу и инженерному сопровождению систем электроэнергетики и автоматизации производственных процессов предприятий энергетического и нефтегазового сектора, параллельно изучая технологии разработки IT- продуктов.</p>
	<p style= 'margin-top: -10px;'>Сейчас, завершив очередной проект, я решил полностью посвятить себя тому, чем давно хотел заниматься,
	а именно – разработке приложений</p>
</div>
<hr>
